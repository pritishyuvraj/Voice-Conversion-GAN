...
def download_vcc2016(download_dir='./download', data_dir='./data'):
    ...
    for data_file in data_files:
        ...
        dataset_filepath = maybe_download(
            filename=data_file, url=url, destination_dir=download_dir, force=False)
        destination_dir = data_dir
        maybe_unzip(zip_filepath=dataset_filepath,
                    destination_dir=destination_dir, force=False)


if __name__ == '__main__':

    parser = argparse.ArgumentParser(
        description='Download CycleGAN voice conversion datasets.')
    ...
    parser.add_argument('--download_dir', type=str,
                        help='Download directory for zipped data', default=download_dir_default)
    parser.add_argument('--data_dir', type=str,
                        help='Data directory for unzipped data', default=data_dir_default)
    parser.add_argument('--datasets', type=str,
                        help='Datasets available: vcc2016', default=datasets_default)
